...
export const CONTROL_ROLES = Object.freeze({
  ...
  operator: [
    ...
    CONTROL_ACTIONS.GALLERY_READ, CONTROL_ACTIONS.LOG_READ, CONTROL_ACTIONS.ARTIFACT_LIST,
    CONTROL_ACTIONS.ARTIFACT_READ, CONTROL_ACTIONS.STREAM_READ, CONTROL_ACTIONS.ARCHIVE_READ,
    CONTROL_ACTIONS.BASELINE_READ, CONTROL_ACTIONS.SETTINGS_READ, CONTROL_ACTIONS.RUN_LAUNCH,
  ...
  reviewer: [
    ...
    CONTROL_ACTIONS.GALLERY_READ, CONTROL_ACTIONS.LOG_READ, CONTROL_ACTIONS.ARTIFACT_LIST,
    CONTROL_ACTIONS.ARTIFACT_READ, CONTROL_ACTIONS.STREAM_READ, CONTROL_ACTIONS.ARCHIVE_READ,
    CONTROL_ACTIONS.BASELINE_READ, CONTROL_ACTIONS.RISK_ACKNOWLEDGE, CONTROL_ACTIONS.RISK_RESOLVE,
  ...
  custodian: [
    ...
    CONTROL_ACTIONS.GALLERY_READ, CONTROL_ACTIONS.LOG_READ, CONTROL_ACTIONS.ARTIFACT_LIST,
    CONTROL_ACTIONS.ARTIFACT_READ, CONTROL_ACTIONS.STREAM_READ, CONTROL_ACTIONS.ARCHIVE_READ,
    CONTROL_ACTIONS.BASELINE_READ, CONTROL_ACTIONS.RUN_PURGE,
  ],
