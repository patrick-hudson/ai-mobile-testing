...
export const CONTROL_ACTIONS = Object.freeze({
  ...
  RUN_DIAGNOSTIC_RERUN: 'run:diagnostic-rerun',
...
export const CONTROL_ROLES = Object.freeze({
  viewer: [
    CONTROL_ACTIONS.RUN_LIST, CONTROL_ACTIONS.RUN_VIEW, CONTROL_ACTIONS.REPORT_READ,
    CONTROL_ACTIONS.GALLERY_READ, CONTROL_ACTIONS.LOG_READ, CONTROL_ACTIONS.ARTIFACT_LIST,
    CONTROL_ACTIONS.ARTIFACT_READ, CONTROL_ACTIONS.STREAM_READ, CONTROL_ACTIONS.ARCHIVE_READ,
    CONTROL_ACTIONS.BASELINE_READ,
  ],
  operator: [
    CONTROL_ACTIONS.RUN_LIST, CONTROL_ACTIONS.RUN_VIEW, CONTROL_ACTIONS.REPORT_READ,
    CONTROL_ACTIONS.GALLERY_READ, CONTROL_ACTIONS.LOG_READ, CONTROL_ACTIONS.ARTIFACT_LIST,
    CONTROL_ACTIONS.ARTIFACT_READ, CONTROL_ACTIONS.STREAM_READ, CONTROL_ACTIONS.ARCHIVE_READ,
    CONTROL_ACTIONS.BASELINE_READ, CONTROL_ACTIONS.SETTINGS_READ, CONTROL_ACTIONS.OPERATION_READ,
    CONTROL_ACTIONS.RUN_LAUNCH,
    CONTROL_ACTIONS.RUN_CANCEL, CONTROL_ACTIONS.RUN_REKICK, CONTROL_ACTIONS.RUN_DIAGNOSTIC_RERUN,
  ],
  reviewer: [
    CONTROL_ACTIONS.RUN_LIST, CONTROL_ACTIONS.RUN_VIEW, CONTROL_ACTIONS.REPORT_READ,
    CONTROL_ACTIONS.GALLERY_READ, CONTROL_ACTIONS.LOG_READ, CONTROL_ACTIONS.ARTIFACT_LIST,
    CONTROL_ACTIONS.ARTIFACT_READ, CONTROL_ACTIONS.STREAM_READ, CONTROL_ACTIONS.ARCHIVE_READ,
    CONTROL_ACTIONS.BASELINE_READ, CONTROL_ACTIONS.OPERATION_READ,
    CONTROL_ACTIONS.RISK_ACKNOWLEDGE, CONTROL_ACTIONS.RISK_RESOLVE,
    CONTROL_ACTIONS.VISUAL_DISPOSITION,
  ],
  custodian: [
    CONTROL_ACTIONS.RUN_LIST, CONTROL_ACTIONS.RUN_VIEW, CONTROL_ACTIONS.REPORT_READ,
    CONTROL_ACTIONS.GALLERY_READ, CONTROL_ACTIONS.LOG_READ, CONTROL_ACTIONS.ARTIFACT_LIST,
    CONTROL_ACTIONS.ARTIFACT_READ, CONTROL_ACTIONS.STREAM_READ, CONTROL_ACTIONS.ARCHIVE_READ,
    CONTROL_ACTIONS.BASELINE_READ, CONTROL_ACTIONS.OPERATION_READ, CONTROL_ACTIONS.RUN_PURGE,
  ],
