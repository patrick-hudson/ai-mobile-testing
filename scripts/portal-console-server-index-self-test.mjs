...
assert.match(source, /readStoreCoordinator\(sharedParentRunStore\)\.catch\(\(\) => null\)/u,
  'An unavailable coordinator snapshot must degrade activity trust without discarding readable run state.');
