(() => {
  ...
  function renderHeader() {
    ...
    const cards = [
      ...
      [manifest.summary.usableInteractionVideos ?? manifest.summary.videos, 'usable interaction videos'],
      ...(manifest.summary.diagnosticVideos ? [[manifest.summary.diagnosticVideos, 'diagnostic videos']] : []),
